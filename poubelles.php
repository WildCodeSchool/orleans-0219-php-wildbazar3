    ...
    <div class="row">
                    ...
                    <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle1.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="prix">€79.95</div>
                                        <p class="card-text textmodal-desc">Lorem ipsum dolor sit amet, consectetur
                                            adipisicing elit. Veritatis eum obcaecati, hic facilis voluptatem harum sint
                                            pariatur, sapiente provident modi, omnis quas animi voluptatum tenetur
                                            repudiandae porro est non. Esse.</p>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 60 cm<br>- Largeur: 35 cm<br>- Poids: 3 klgs
                                    </p>
                                </div>
                    ...
                    <div class="modal fade" id="modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 55 cm<br>- Largeur: 30 cm<br>- Poids: 2,5 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="modal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Poubelle dual inox stainless
                                        steel</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle3.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 80 cm<br>- Largeur: 65 cm<br>- Poids: 8 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="modal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Poubelle rose 30 litres Automatic
                                        Sensor</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="img/poubelle4.png" class="card-img-top"
                                             alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 50 cm<br>- Largeur: 35 cm<br>- Poids: 4 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6">
            ...
            <div class="card">
                ...
                <img src="img/poubelle5.png" class="card-img-top"
                     alt="Retro cuir Home / Office Bureau Trash Can Bin Poubelle Taxi">
                <div class="card-body">
                    ...
                    <div class="modal fade" id="modal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Retro cuir Home / Office Bureau Trash
                                        Can Bin</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 40 cm<br>- Largeur: 25 cm<br>- Poids: 2 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle6.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle7.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 90 cm<br>- Largeur: 55 cm<br>- Poids: 13 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle8.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle9.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 80 cm<br>- Largeur: 45 cm<br>- Poids: 10 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle10.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 80 cm<br>- Largeur: 105 cm<br>- Poids: 30 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle11.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="modal12" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Touchless 60 Litres Stainless Steel
                                        Automatic</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="modal-body">
                                            <img src="img/poubelle12.png" class="card-img-top"
                                                 alt="poubelle-inox-50-litres-a-pedale">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <p class="textmodal-cara">- Hauteur: 80 cm<br>- Largeur: 35 cm<br>- Poids: 5 klgs
                                    </p>
                                </div>
                                <div class="modal-footer">
