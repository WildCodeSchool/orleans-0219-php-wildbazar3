...
<header>
    ...
    <div class="jumbotron w-100">
        ...
        <p class="lead">Hundreds of books ! Thousands of books ! And even more...</p>
...
<section id="books">
    ...
    <div class="container">
        ...
        <div class="text-center">
            <a href="formBook.php"><button type="submit" class="btn btn_item2 btn_itemblock">Add a book</button></a>
        </div>
    </div>
